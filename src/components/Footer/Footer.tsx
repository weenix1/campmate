                            ...
                            <div className="company-infor lg:w-1/4 sm:w-1/2">
                                <div className="flex items-center gap-4">
                                    ...
                                    >
                                        ...
                                        <path
                                            opacity="0.5"
                                            d="M31.8456 16.125C31.2006 16.125 30.6906 15.6 30.6906 14.97C30.6906 9.645 26.3556 5.325 21.0456 5.325C20.4006 5.325 19.8906 4.8 19.8906 4.17C19.8906 3.54 20.4006 3 21.0306 3C27.6306 3 33.0006 8.37 33.0006 14.97C33.0006 15.6 32.4756 16.125 31.8456 16.125Z"
                                            fill="#E05028"
                                        />
                                        <path
                                            opacity="0.5"
                                ...
                                <div className="form-search mt-5">
                                    ...
                                    <form className="w-full relative rounded-lg overflow-hidden">
                                        <input
                                            ...
                                            className="caption1 h-[46px] pl-4 pr-14 w-full rounded-lg"
                                        />
                    ...
                    <div className="footer-bottom py-4 border-t border-outline">
                        <div className="container">
                            <div className="flex items-center sm:justify-between justify-center flex-wrap gap-4">
                                <div className="copyright caption1 text-variant1">
                                    ©2023 CampingMate. All Rights Reserved.
                                </div>
