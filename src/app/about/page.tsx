                ...
                <div className="container">
                    <div className="heading flex flex-col items-center justify-center">
                        <div className="heading2 text-center">
                            Welcome to the CampingMate
                        </div>
                        <div className="body2 text-variant1 text-center mt-4">
                            Less than a 2.5 hour drive from downtown Boston and
                            convenient to the trailheads, scenic views and
                            swimming holes of the White Mountain National
                            Forest, Huttopia White Mountains is an ideal place
                            to escape to nature.
                        </div>
                    </div>
                    <div className="video-block relative rounded-[20px] overflow-hidden md:mt-10 mt-6">
                        ...
                        >
                            <Icon.Play
                                className="lg:text-5xl sm:text-4xl text-3xl text-white"
                                weight="fill"
                            />
                        </div>
                    </div>
                        ...
                        <div className="item">
                            ...
                            <div className="flex items-center justify-between mt-5">
                                <div>
                                    ...
                                    <div className="caption1 text-variant1 mt-1">
                                        Graphic Designer
                                    </div>
                                </div>
                                <Link
