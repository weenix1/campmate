  ...
  return (
    <>
      <div className='overflow-hidden'>
        <HeaderOne />
        <div className="style-halfmap">
          <div className="content-main flex h-full max-md:flex-col-reverse">
            <div className="left md:w-7/12 lg:pt-10 md:pt-6 lg:px-10 md:px-6 px-4 max-md:py-8 relative">
